/**
 * Tip-jar store product ids for Tally — app-owned (NOT synced from the
...
export const TIP_PRODUCT_IDS = [
  'com.joshapproved.tally.tip.tier1',
  'com.joshapproved.tally.tip.tier2',
  'com.joshapproved.tally.tip.tier3',
  'com.joshapproved.tally.tip.tier4',
  'com.joshapproved.tally.tip.tier5',
] as const;
